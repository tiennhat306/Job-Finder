...
public class JobBoardBO {
	...
	public int createJob(String title, String code, String companyName, int companySize, String companyDescription,
		...
		return jobBoardDAO.createJob(title, code, companyName, companySize, companyDescription, website, cityId,
				address, jobType, rank, salaryType, salaryFrom, salaryTo, ageType, ageFrom, ageTo, genderType,
				jobDescription, quantity, qualification, yearsOfExperience, requirements, benefits, contactAddress,
