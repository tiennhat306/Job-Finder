...
<div class="navbar-custom">
  <ul class="list-unstyled topnav-menu float-right mb-0">
    ...
    <li class="dropdown notification-list">
      ...
      >
        <%
          AdminSessionItem authUser = (AdminSessionItem) session.getAttribute("adminSession");
          if (!authUser.getAvatar().equals("")) {
        %>
        <img
                src="<%= authUser.getAvatar() %>"
                alt="user-image"
                class="rounded-circle"
        />
        <% } else { %>
        <img
                src="https://api.dicebear.com/6.x/initials/svg?seed=<%= authUser.getName() %>"
                alt="user-image"
                class="rounded-circle"
        />
        <% } %>
      ...
      <div class="dropdown-menu dropdown-menu-right profile-dropdown">
        ...
        <!-- item-->
        <a href="AdminAccountServlet" class="dropdown-item notify-item">
          <i class="fe-user"></i>
          <span>Tài khoản</span>
        </a>
        ...
        <!-- item-->
        <a href="AdminLogoutServlet" class="dropdown-item notify-item">
